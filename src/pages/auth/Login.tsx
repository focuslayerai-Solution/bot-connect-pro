      ...
      <div className="hidden lg:flex lg:w-1/2 lg:flex-col lg:justify-center gradient-hero p-12">
        <div className="mx-auto max-w-md text-center">
          ...
          <p className="mt-4 text-lg text-primary-foreground/80">
            Deploy pre-built bots for restaurants, salons, and more. 
            Let AI handle customer conversations 24/7.
          </p>
          <div className="mt-8 flex justify-center gap-8 text-primary-foreground/70">
